...
class FaceEnrollmentServiceV2:
        ...
        try:
            ...
            if check_duplicate:
                ...
                if duplicate_info:
                    ...
                    result["message"] = f"⚠️ Phát hiện trùng lặp với: {duplicate_info['user_name']} (folder: {duplicate_info['folder_name']}, Độ tương đồng: {duplicate_info['similarity']:.1f}%)"
    ...
    def add_image_to_existing_person(
        self, 
        image_path: str, 
        folder_name: str
    ) -> Dict:
        ...
        try:
            ...
            if not face_encodings:
                return {
                    "success": False,
                    "message": "❌ Không thể trích xuất đặc trưng"
                }
