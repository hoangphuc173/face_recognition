...
class DatabaseManager:
    ...
    def update_person_info(
        ...
        if not info:
            return {"success": False, "message": f"❌ Không tìm thấy: {folder_name}"}
        ...
        return {"success": True, "message": f"✅ Đã cập nhật thông tin: {folder_name}"}
    ...
    def delete_person(self, folder_name: str) -> Dict:
        ...
        return {"success": True, "message": f"✅ Đã xóa: {folder_name}"}
